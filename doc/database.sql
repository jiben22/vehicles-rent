...
CREATE TABLE booking (
    ...
    expected_number_km INT NOT NULL,
...
INSERT INTO car (id, brand, maximum_speed, model, nb_seats, rent_price_per_day, state, registration, horse_power, km) VALUES
(42, 'acura', 185, 'ilx', 7, 318.2, 'Etat excellent', 'CM-455-ZP', 201, 150),
(43,'ferrari',300,'roma',2,600.5,'Etat bon', 'AS-457-RT', 500, 20000),
(44,'renault',160,'clio',5,100,'Etat excellent', 'FG-875-DG', 100, 15000),
(45,'mazda',200,'mx5',2,160.4,'Etat très bien', 'QS-789-HG', 170, 5000),
(46,'toyota',160,'yaris',5,70,'Etat passable', 'WS-157-JK', 90, 50000);

INSERT INTO motorbike (id, brand, maximum_speed, model, nb_seats, rent_price_per_day, state, registration, horse_power, km) VALUES
(782,'kawasaki',190,'vulcan s',2,100.5,'Etat excellent', 'KL-789-KJ', 60, 1200),
(783,'suzuki','250','cb100rr',1,350.8,'Etat bon', 'ER-673-RT', 120, 5000),
(784,'moto guzzi','160','v7III',2,200.12,'Etat très bien', 'OS-583-BV', 70, 2000),
(785,'yahma','195','mt-07',2,160.49,'Etat passable', 'MX-465-FT', 67, 15000);

INSERT INTO plane (id, brand, maximum_speed, model, nb_seats, rent_price_per_day, state, registration, nb_engines, nb_hours) VALUES
(12679, 'robin',300,'dr400',4,900,'Etat bon', 'RS-111-TR', 1, 1000),
(12680, 'cessna',350,'172sp',4,1500,'Etat excellent', 'SA-222-BU', 1, 50),
(12681, 'beechraft',400,'baron g58',6,2500,'Etat passable', 'AR-333-PO', 2, 50000),
(12682, 'piper',370,'seneca',4,200,'Etat très bien', 'BO-444-EI', 2, 12000);
